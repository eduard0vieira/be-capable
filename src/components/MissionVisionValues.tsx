    ...
    <section id="valores" className="py-24 bg-[#F5F5F0]">
      <div className="max-w-5xl mx-auto px-6 lg:px-8" ref={ref}>
        ...
        <motion.p
          ...
          className="font-serif text-xl md:text-2xl text-[#800020] text-center mt-12 max-w-2xl mx-auto leading-relaxed"
        >
          Destinamos uma parte do nosso faturamento para apoiar projetos e missões humanitárias na África.
        </motion.p>
      </div>
    </section>
  );
