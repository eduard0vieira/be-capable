...
const services = [
  ...
  },
  {
    ...
    description: "Edição profissional que transforma seu conteúdo bruto em vídeos impactantes e otimizados.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Planejamento estratégico de conteúdo para manter consistência e relevância nas suas publicações.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
